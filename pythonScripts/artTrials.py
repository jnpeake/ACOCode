...
with open('monalisastatsmapFINAL.csv', 'w') as csvfile:
...
with open('monalisastatsFINAL.csv', 'w') as csvfile:
	resultWriter = csv.writer(csvfile, delimiter=',',
                            quotechar='|', quoting=csv.QUOTE_MINIMAL)
	for i in range(10):
		resultWriter.writerow(['Run: ' + str(i)])
...
with open('vangoughstatsFINAL.csv', 'w') as csvfile:
	resultWriter = csv.writer(csvfile, delimiter=',',
                            quotechar='|', quoting=csv.QUOTE_MINIMAL)
	for i in range(5):
		resultWriter.writerow(['Run: ' + str(i)])
...
with open('venusstatsFINAL.csv', 'w') as csvfile:
	resultWriter = csv.writer(csvfile, delimiter=',',
                            quotechar='|', quoting=csv.QUOTE_MINIMAL)
	for i in range(5):
		resultWriter.writerow(['Run: ' + str(i)])
...
with open('earringstatsFINAL.csv', 'w') as csvfile:
	resultWriter = csv.writer(csvfile, delimiter=',',
                            quotechar='|', quoting=csv.QUOTE_MINIMAL)
	for i in range(5):
		resultWriter.writerow(['Run: ' + str(i)])
